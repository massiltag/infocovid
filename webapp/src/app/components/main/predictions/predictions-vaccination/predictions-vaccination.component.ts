...
export class PredictionsVaccinationComponent implements OnInit {
  ...
  *  Afin de pouvoir relier la ligne de vaccination r�elle avec la ligne de vaccination pr�dit 
  ...
  */
  ...
  cleanForChart(metrics: Metrics[]): any[] {
    ...
    for(this.i = 0; this.i < temp; this.i++) {
        ...
        // Ligne de vaccination pr�dit, ajout des valeurs pr�dit 
        cum_dose1_prev.push({
